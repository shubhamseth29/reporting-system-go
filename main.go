...
func getPDF(c *gin.Context) {
	...
	// Create contexts.
	// actxt, cancelActxt := chromedp.NewRemoteAllocator(context.Background(), "http://43.205.133.32:9222")
	// defer cancelActxt()
	...
	<head>
		...
		<script src="https://www.amcharts.com/lib/version/4.5.3/core.js"></script>
		<script src="https://www.amcharts.com/lib/version/4.5.3/charts.js"></script>
...
// `
    ...
    //     chromedp.Navigate("about:blank"),
		// chromedp.ActionFunc(func(ctx context.Context) error {
		// 	_, err := page.AddScriptToEvaluateOnNewDocument(jquery).Do(ctx)
		// 	return err
		// }),
		// chromedp.ActionFunc(func(ctx context.Context) error {
		// 	_, err := page.AddScriptToEvaluateOnNewDocument(core).Do(ctx)
		// 	return err
		// }),
		// chromedp.ActionFunc(func(ctx context.Context) error {
		// 	_, err := page.AddScriptToEvaluateOnNewDocument(chart).Do(ctx)
		// 	return err
		// }),
		// chromedp.ActionFunc(func(ctx context.Context) error {
		// 	_, err := page.AddScriptToEvaluateOnNewDocument(material).Do(ctx)
		// 	return err
		// }),
		// chromedp.ActionFunc(func(ctx context.Context) error {
		// 	_, err := page.AddScriptToEvaluateOnNewDocument(mapVar).Do(ctx)
		// 	return err
		// }),
		// chromedp.Evaluate(loadScripts, nil, func(p *runtime.EvaluateParams) *runtime.EvaluateParams {
    ...
    //     chromedp.ActionFunc(func(ctx context.Context) error {
    //         buf, _, err := page.PrintToPDF().WithPaperWidth(12).WithPrintBackground(false).Do(ctx)
    //         if err != nil {
    //             return err
    //         }
			
    //         return ioutil.WriteFile("Report" + uuid.New().String() + ".pdf", buf, 0644)
    //     }),
    // ); err != nil {
    //     log.Fatal(err)
    // }
...
func execute(html string , c *gin.Context){
	ctx, cancel := chromedp.NewContext(context.Background(), 
	chromedp.WithDebugf(log.Printf))
    defer cancel()
	var filename string = "Report" + uuid.New().String() + ".pdf"
	if err := chromedp.Run(ctx,
        chromedp.Navigate("about:blank"),
		chromedp.ActionFunc(func(ctx context.Context) error {
            frameTree, err := page.GetFrameTree().Do(ctx)
...
// page.AddScriptToEvaluateOnNewDocument("https://code.jquery.com/jquery-3.2.1.min.js")
// page.AddScriptToEvaluateOnNewDocument("https://www.amcharts.com/lib/version/4.5.3/core.js")
// page.AddScriptToEvaluateOnNewDocument("https://www.amcharts.com/lib/version/4.5.3/charts.js")
// page.AddScriptToEvaluateOnNewDocument("https://www.amcharts.com/lib/4/themes/material.js")
// page.AddScriptToEvaluateOnNewDocument("https://www.amcharts.com/lib/4/themes/dark.js")
// page.AddScriptToEvaluateOnNewDocument("https://www.amcharts.com/lib/4/themes/animated.js")
// page.AddScriptToEvaluateOnNewDocument( "https://www.amcharts.com/lib/3/ammap.js")
// page.AddScriptToEvaluateOnNewDocument("https://www.amcharts.com/lib/3/maps/js/worldLow.js")
// page.AddScriptToEvaluateOnNewDocument("https://www.amcharts.com/lib/3/themes/light.js")
